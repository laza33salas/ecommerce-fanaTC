...
{
    /// <inheritdoc />
    public partial class InitMigration33 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrecioTransferencia = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderAdressId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_OrderAdresses_OrderAdressId",
                        column: x => x.OrderAdressId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_OrderAdressId",
                table: "Orders",
                column: "OrderAdressId");
